...
class SpeechCommands12DataModule(pl.LightningDataModule):
    def __init__(self, batch_size=32, pin_memory=True, num_workers=4, root="./", augmentation=True):
        ...
        self.train_ds = SpeechCommands12("training", root=root)
        self.test_ds = SpeechCommands12("testing", root=root)
        self.validation_ds = SpeechCommands12("validation", root=root)
